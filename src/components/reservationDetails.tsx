    ...
    <>
      <main>
        <div className="mx-auto max-w-full">
          <div className="mx-auto grid max-w-full grid-cols-1 grid-rows-1 items-start gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {/* Invoice summary */}
            <div className="lg:col-start-3 lg:row-end-1">
              <div className="rounded-lg bg-gray-50 shadow-sm ring-1 ring-gray-900/5">
                <dl className="flex flex-wrap">
                  <div className="flex-auto pl-6 pt-6">
                    <dt className="text-sm font-semibold leading-6 text-gray-900">Room</dt>
                    <dd className="mt-1 text-base font-semibold leading-6 text-gray-900">Family Suite</dd>
                  </div>
                  <div className="flex-none self-end px-6 pt-4">
                    <dt className="sr-only">Status</dt>
                    <dd className={`rounded-md bg-green-50 px-2 py-1 text-xs font-medium ${selectedState.online} ring-1 ring-inset ring-green-600/20`}>
                     {selectedState.name}
                    </dd>
                  </div>
                  <div className="mt-6 flex w-full flex-none gap-x-4 border-t border-gray-900/5 px-6 pt-6">
                    ...
                    <dd className="text-sm font-medium leading-6 text-gray-900">No Client</dd>
                  </div>
                  ...
                  <div className="mt-4 flex w-full flex-none gap-x-4 px-6">
                    ...
                    <dd className="text-sm leading-6 text-gray-500">No payment Selected</dd>
                  </div>
                </dl>
                <div className="mt-6 border-t border-gray-900/5 px-6 py-6">
                  <a href="#" className="text-sm font-semibold leading-6 text-gray-900">
                    Change Room Status <span aria-hidden="true">&rarr;</span>
            ...
            <div className="-mx-4 px-4 py-8 shadow-sm ring-1 ring-gray-900/5 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-16 xl:pb-20 xl:pt-16">
              <h2 className="text-base font-semibold leading-6 text-gray-900">Reservation Details</h2>
              <dl className="mt-6 grid grid-cols-1 text-sm leading-6 sm:grid-cols-2">
                <div className="sm:pr-4">
                  <dt className="inline text-gray-500">Check in</dt>{' '}
                  <dd className="inline text-gray-700">
                    <time dateTime="2023-23-01">January 23, 2023</time>
                  </dd>
                </div>
                <div className="mt-2 sm:mt-0 sm:pl-4">
                  <dt className="inline text-gray-500">Check Out</dt>{' '}
                  <dd className="inline text-gray-700">
                ...
                <div className="mt-6 border-t border-gray-900/5 pt-6 sm:pr-4">
                  ...
                  <dd className="mt-2 text-gray-500">
                    ...
                    <br />
                    Phone Number : 06 961 942 61
                  </dd>
                </div>
                <div className="mt-8 sm:mt-6 sm:border-t sm:border-gray-900/5 sm:pl-4 sm:pt-6">
                  <dt className="font-semibold text-gray-900">Details</dt>
                  <dd className="mt-2 text-gray-500">
                    <span className="font-medium text-gray-900">Number Of Persons : 3</span>
                    <br />
                    Adults : 2
                    <br />
                    Kids : 1
