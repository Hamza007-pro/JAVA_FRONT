                                                ...
                                                <li key={item.name}>
                                                    ...
                                                    <Menu as="div"
                                                        className={classNames(
                                                            ...
                                                            'group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold relative inline-block text-left'
                                                        )}
                                                    >
                                                        <div>
                            ...
                            <li key={item.name}>
                                ...
                                >
                                    ...
                                    <Transition
                                        ...
                                        leaveTo="transform opacity-0 scale-95"
                                    >
                                        <Menu.Items className="absolute -right-40 z-10 mt-2 w-auto origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                            <div className="py-1">
                                                {item.links?.map((link) => (
