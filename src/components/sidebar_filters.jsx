...
const filters = [
  {
    ...
    name: 'Size',
    options: [
      { value: '30-40 sqm', label: '30sqm' },
      { value: '40-55 sqm', label: '40sqm' },
      { value: '55-80 sqm', label: '55sqm' },
      { value: '80+ sqm', label: '80+sqm' },
    ],
  },
  {
    id: 'Facilities',
    ...
    options: [
      ...
      { value: 'Safety Box', label: 'Safety Box' },
    ],
  },
  {
    id: 'Room Style',
